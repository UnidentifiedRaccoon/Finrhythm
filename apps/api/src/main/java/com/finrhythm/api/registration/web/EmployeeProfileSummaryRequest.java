...
@Schema(
        name = "EmployeeProfileSummaryRequest",
        description = "Submitted contact and invite-code proof for a read-only employee profile summary lookup."
)
public record EmployeeProfileSummaryRequest(
