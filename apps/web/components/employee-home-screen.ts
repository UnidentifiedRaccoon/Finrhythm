...
const homeSections = [
  {
    body: "Сначала Q0 про приватность, затем короткая самооценка и несколько пробных карточек без сохранения ответов.",
    cta: "Открыть диагностику",
    href: "/diagnostics",
    title: "Диагностика"
  },
  {
    body: "Короткий маршрут N1-N7 с пробными уроками и безопасными практиками без точных личных сумм.",
